...
if __name__ == "__main__":
    ...
    with open(f"sim2sim/configs/{config_file}", "r") as f:
        ...
        body_height_cmd = config.get("body_height_cmd", 0.53)
        ...
        gait_frequency_range = config.get("gait_frequency_range", [2.5, 3.5])
        ...
        body_height_range = config.get("body_height_range", [0.25, 0.55])
