...
def play(args):
    ...
    env_cfg.commands.tracking_ee_start_step = 10000
...
if __name__ == '__main__':
    ...
    args.task= 'cowa_wbc' #'cowa_dh'
    args.experiment_name = args.task
    args.load_run = "Mar05_19-48-39_v2_dh_wbc_[wo_RD]_[v0.1_PD]_[wo_force]_[arm_command_curriculum]_[tracking_ee_combine=10]_[tracking_ee_pos_sigma=1.0]_[alpha_low_smaller]_[arm_commands_scale]"
    args.checkpoint = -1
    args.headless = False
    args.num_envs = 1
