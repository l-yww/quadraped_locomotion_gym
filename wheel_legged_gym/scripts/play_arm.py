...
def play(args):
    ...
    if "force" in args.task:
        env_cfg.commands.push_gripper_stators = True #False
    ...
    if EXPORT_POLICY:
        ...
        if "him" in args.task and "terrain" in args.task: 
            ...
            integrated_policy = Integrated_TS_policy(ppo_runner.alg.actor_critic.actor, # actor
                                                ...
                                                env_cfg.env.num_single_obs, env_cfg.env.frame_stack)
            integrated_policy.export(path, args.load_run)  
        elif args.task == 'cowa_dh' or args.task == 'cowa_4dof' or args.task == 'cowa_8dof_plane' or args.task == 'cowa_10dof' or args.task == 'cowa_10dof_p3o' or args.task == 'cowa_wbc' or args.task == 'cowa_arm' or args.task == 'cowa_arm_force':
    ...
    for i in range(stop_state_log * 10):
        ...
        if "roa" in args.task and "terrain" in args.task:
            ...
            # print("arm_actor_obs_single",obs_history[:,-1:,:])
...
if __name__ == '__main__':
    ...
    args.task= 'cowa_arm_force' #'cowa_dh'
    args.experiment_name = args.task
    args.load_run = "Apr01_10-51-13_v2_arm_force_[w_DR]_[command_set_maker]"
    args.checkpoint = -1
    args.headless = False
    args.num_envs = 1
