    ...
    if EXPORT_POLICY:
        ...
        if "him" in args.task and "terrain" in args.task: 
            ...
            integrated_policy = Integrated_Prop_policy(ppo_runner.alg.actor_critic.actor, # actor
                                                ...
                                                ppo_runner.alg.actor_critic.in_channels,
                                                ppo_runner.alg.actor_critic.num_proprio_obs)
        elif args.task == 'quadruped' or args.task == 'quadruped_wtw' or args.task == 'quadruped_wtw_slope':
...
if __name__ == '__main__':
    ...
    #args.load_run = 'Jun05_12-21-19_30kg'
    #args.load_run = 'Jun05_12-20-26_0kg'
    args.load_run = '负载-ptich-对称性loss-高度-站立'
    #args.load_run = 'arm固定-加强静止'

    #args.load_run = '负载-抬腿-ptich-对称性loss-高度-站立'
    # args.load_run = '航向角'
    args.checkpoint = 17800
