...
def play(args):
    ...
    env_cfg.terrain.terrain_proportions =  [0.5, 0., 0.5, 0, 0., 0., 0, 0, 0, 0]
    ...
    if EXPORT_POLICY:
        ...
        if "him" in args.task and "terrain" in args.task: 
            ...
            integrated_policy = Integrated_Prop_policy(ppo_runner.alg.actor_critic.actor, # actor
                                                ...
                                                ppo_runner.alg.actor_critic.in_channels,
                                                ppo_runner.alg.actor_critic.num_proprio_obs)
        elif args.task == 'quadruped_wtw_him_arm_fix' or args.task == 'quadruped_wtw_him_arm_fix_amp':
    ...
    for i in range(stop_state_log * 10):
        ...
        if "him" in args.task:
            ...
            obs, critic_obs, rews, dones, infos = step_out[0], step_out[1], step_out[2], step_out[3], step_out[4]
        elif "prop" in args.task:
...
if __name__ == '__main__':
    ...
    #args.load_run = 'Jun19_17-49-31_test' #good
    args.load_run = '0810'
    args.checkpoint = 3500
