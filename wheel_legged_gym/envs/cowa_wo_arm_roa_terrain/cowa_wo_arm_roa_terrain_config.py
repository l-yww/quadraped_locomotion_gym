...
class CowaCfg_2(LeggedRobotCfg):
    """
    ...
    class env(LeggedRobotCfg.env):
        ...
        num_expert_input = 3 + 1 + 4       # dim = vel_xzy + base_height  
        num_latent = 5  # NOTE: Is it to small ???
        ...
        single_num_privileged_obs = num_single_obs + 12 + 1 + 3 + 6 + 6 + 6 + num_height_scan_input + num_expert_input   # dim=126
    ...
    class domain_rand(LeggedRobotCfg.domain_rand):
        ...
        heights_lag_timesteps_range = [1, 55] # 2 ~ 110ms  # NOTE: so big big big ...
    ...
    class rewards:
        ...
        class scales:
            ...
            dof_pos_limits = -0.1
            dof_vel_limits = -0.1
            stand_still_vel_penality = -10.0  # -20
            same_foot_z_position = 15.0
            # stand_still_wheel_vel_penality = -10
            # stand_still_wheel_vel = 1.0
            # default_joint_pos = 0.2
            # same_foot_z_position = 10.5
            feet_xy_contact_forces = -0.5
...
class CowaCfgPPO_2(LeggedRobotCfgPPO):
    seed = 10
    runner_class_name = 'OnPolicyRunner_Lidar_ROA_2'
    ...
    class policy(LeggedRobotCfgPPO.policy):
        ...
        # roa para
        expert_hidden_dims=[64, 32] # cut small
        adaptation_hidden_dims=[128, 64]
    ...
    class runner:
        ...
        experiment_name = 'hahaha'
        run_name = 'hahaha'
        # Load and resume
        resume = False
        load_run = -1  # -1 = last run
        checkpoint = -1  # -1 = last saved model
        resume_path = 'hahaha'  # updated from load_run and chkpt
