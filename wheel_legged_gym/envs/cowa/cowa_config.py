...
class CowaCfg(LeggedRobotCfg):
    ...
    class env(LeggedRobotCfg.env):
        ...
        num_single_obs = 3 + 3*num_actions - 2 + 6 -1 # cmd + dof pos[w/o wheel] + dof vel + action + imu
        ...
        single_num_privileged_obs = num_single_obs + 3 + 1
    ...
    class asset(LeggedRobotCfg.asset):
        ...
        file = f"{WHEEL_LEGGED_GYM_ROOT_DIR}/resources/robots/cowa_wheel_legged_v2/cowa_wheel_legged_v2/urdf/wheel_v2_6dof_wo_arm.urdf"
    ...
    class rewards:
        ...
        class scales:
            ...
            " 脚部姿态 "
            same_wheel_x_position = -2 #-1
            wheel_distance = 0.2
            # default_joint_pos = -0.1
            # nominal_wheel_position = 0.5
            ############## normalized rewards #####################
            lin_vel_z = -0.3
            ang_vel_xy = -0.3
