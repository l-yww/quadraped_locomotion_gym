import numpy as np
import torch
from wheel_legged_gym.envs.cowa_arm.legged_robot_config import LeggedRobotCfg, LeggedRobotCfgPPO
...
class CowaCfg(LeggedRobotCfg):
    ...
    class env(LeggedRobotCfg.env):
        ...
        num_single_obs = 12 + 3*num_actions + 3
        
    
        num_observations = int(frame_stack * num_single_obs)

        single_num_privileged_obs = num_single_obs + num_est_prob + 3
    ...
    class asset(LeggedRobotCfg.asset):
        ...
        file = f"{WHEEL_LEGGED_GYM_ROOT_DIR}/resources/robots/cowa_wheel_legged_v2/cowa_wheel_legged_v2/urdf/wheel_v2_w_arm.urdf"
        ...
        self_collisions = 1 #0 # 1 to disable, 0 to enable...bitwise filter
        fix_base_link = True #False # fix the base of the robot
    ...
    class domain_rand(LeggedRobotCfg.domain_rand):
        ...
        motor_strength_range = [0.7, 1.3]      #[0.8,1.2]  
        ...
        randomize_motor_offset = False #use_random # 目前是使用torque的offset
    ...
    class commands(LeggedRobotCfg.commands):
        ...
        # gripper_force_kp_range = [0.05, 0.05]
        gripper_force_kp_range = [0.01, 0.01]
        gripper_force_kd_range = [6.0, 6.0]
        gripper_prop_kd = 0.1
        push_gripper_stators = True

        max_push_force_xyz_gripper_cmd = [-20, 20]
        max_push_force_xyz_gripper_ext = [-20, 20]
        max_force_cmd_range = 40
        max_force_ext_range = 40
        settling_time_force_gripper_s = 1.0
        test_chip = False

        force_start_step = 5000 #1000 #ext_force
    ...
    class rewards:
        ...
        class scales:
            ...
            tracking_ee_world_new = 0.0
            tracking_ee_force_world = 0.0
            tracking_ee_combine = 5.0
            collision = -5
            termination = 0.0
            dof_acc = -4.5e-7
            dof_pos_limits = -10
