...
class CowaCfg(LeggedRobotCfg):
    ...
    class env(LeggedRobotCfg.env):
        ...
        c_frame_stack = 2
        ## obs nums
        num_single_obs = 25 #+ 63 
        num_observations = int(frame_stack * num_single_obs)  

        single_num_privileged_obs = num_single_obs + 12 + 4 + 1 + 3 + 6 + 6 + 6
    ...
    class asset(LeggedRobotCfg.asset):
        ...
        file = "{WHEEL_LEGGED_GYM_ROOT_DIR}/resources/robots/cowa_wheel_legged_deployed/urdf/cowa_jiaozhun.urdf"     
        name = "cowa_robot"
        offset = 0.
        l1 = 0.25
        l2 = 0.25
    ...
    class terrain(LeggedRobotCfg.terrain):
        ...
        terrain_proportions = [0., 0., 0., 1., 0.1, 0, 0]
    ...
    class domain_rand(LeggedRobotCfg.domain_rand):
        ...
        imu_lag_timesteps_range = [4, 8] # �E10~22ms
...
class CowaCfgPPO_RMA(LeggedRobotCfgPPO):
    seed = 10
    ...
    class runner:
        ...
        resume_path = '/home/cowa_rma'  # updated from load_run and chkpt