from wheel_legged_gym.envs.cowa_prop.legged_robot_config import LeggedRobotCfg, LeggedRobotCfgPPO
...
class CowaCfg(LeggedRobotCfg):
    ...
    class env(LeggedRobotCfg.env):
        ...
        num_actions = 4
        num_single_obs = 3*num_actions - 2 + 6 # dof pos[w/o wheel] + dof vel + action + imu
...
class CowaCfgPPO(LeggedRobotCfgPPO):
    seed = 10
    runner_class_name = 'OnPolicyRunner_DH_prop'   # OnPolicyRunnerEstimator
    ...
    class runner(LeggedRobotCfgPPO.runner):
        policy_class_name = 'ActorCritic_DH_prop'
        algorithm_class_name = 'PPO_DH_prop'
