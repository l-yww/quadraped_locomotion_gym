...
class QuadWtwCfg(LeggedRobotCfg):
    ...
    class env(LeggedRobotCfg.env):
        ...
        single_num_privileged_obs = num_single_obs + num_est_prob # vel + base_height
...
class QuadWtwCfgPPO(LeggedRobotCfgPPO):
    ...
    class policy(LeggedRobotCfgPPO.policy):
        ...
        kernel_size=[6, 4]   #第一个卷积核看6帧，第二个看4帧
        filter_size=[32, 16]  #第一个卷积输出32维特征，第二个输出16维特征
        stride_size=[3, 2] #一步跨 3 格
        lh_output_dim= 64   # long history output dim
        in_channels = QuadWtwCfg.env.frame_stack
