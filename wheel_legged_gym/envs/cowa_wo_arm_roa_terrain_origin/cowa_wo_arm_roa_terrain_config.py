...
class CowaCfg(LeggedRobotCfg):
    ...
    class env(LeggedRobotCfg.env):
        ...
        num_height_scan_output = 15
        # rma params  
        num_expert_input = num_height_scan_input + 3 + 1  # dim= heights + vel_xzy + base_height  
        num_latent = 25
        ...
        single_num_privileged_obs = num_single_obs + 12 + 1 + 3 + 6 + 6 + 6 + num_expert_input #dim=126
    ...
    class asset(LeggedRobotCfg.asset):
        ...
        file = "{WHEEL_LEGGED_GYM_ROOT_DIR}/resources/robots/cowa_wheel_legged_deployed/urdf/cowa_jiaozhun_no_collision.urdf"     
        name = "cowa_robot"
        offset = 0.
        l1 = 0.25
        l2 = 0.25
        foot_name = "wheel"
        penalize_contacts_on = ["base", "hand_center", "battery", "hip", "knee"] 
...
class CowaCfgPPO(LeggedRobotCfgPPO):
    seed = 10
    runner_class_name = 'OnPolicyRunner_Lidar_ROA'
