...
class CowaCfg(LeggedRobotCfg):
    ...
    class domain_rand(LeggedRobotCfg.domain_rand):
        ...
        com_displacement_range = [-0.05, 0.05] #[-0.08, 0.08]  # base link com的随机化范围
...
class CowaCfgPPO(LeggedRobotCfgPPO):
    seed = 10
    runner_class_name = 'OnPolicyRunner_VAE_Smooth'   # OnPolicyRunnerEstimator
    ...
    class runner(LeggedRobotCfgPPO.runner):
        policy_class_name = 'ActorCritic_VAE_Smooth' #'ActorCritic_DH'
        algorithm_class_name = 'PPO_VAE_Smooth' #'PPO_DH'
