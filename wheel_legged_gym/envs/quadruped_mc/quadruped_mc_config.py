...
class QuadMCCfg(LeggedRobotCfg):
    class mode:
        use_net = True
    ...
    class terrain(LeggedRobotCfg.terrain):
        ...
        terrain_proportions = [0.2, 0.1, 0.1, 0.25, 0.25, 0.0, 0, 0, 0.05, 0.05]
        # trimesh only:
...
class QuadMCCfgPPO(LeggedRobotCfgPPO):
    seed = 10
