...
class ActorCritic(nn.Module):
    def __init__(self,  num_actor_obs,
        ...
        # actor和critic的输入维度
        # TODO add height_scan outputs
        mlp_input_dim_a = num_actor_obs * actor_input_stack + num_latent + num_height_scan_output
    ...
    # teacher encoder
    def act_expert(self, obs_input, expert_input, obs_height):
        height_latent = self.height_scan_encoder.forward(obs_height)
