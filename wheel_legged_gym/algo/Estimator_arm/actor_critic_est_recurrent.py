...
class ActorCriticRecurrent(ActorCritic_Estimator):
    is_recurrent = True
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.vel_estimator = vel_estimator(num_actor_obs, 3, activation, estimator_hidden_dims)
        print(self.vel_estimator)
    ...
    def act(self, observations, masks=None, hidden_states=None):
        velocity = self.vel_estimator(observations)
