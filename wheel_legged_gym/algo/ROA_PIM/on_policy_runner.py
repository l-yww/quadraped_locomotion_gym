# NOTE: This 'ROA_height_scan' is for 
## height-encoder-->l1
## l1 + history-encoder-->l2
## l2+prop --> actor
## expert-encoder only includes v and h but height_scans !!!
### TODO It's different from ROA_height_scan_2 !!!!
...
class OnPolicyRunner_Lidar_ROA:
